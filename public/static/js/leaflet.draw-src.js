 ...
 *});
    ...
    L.Draw.Polyline = L.Draw.Feature.extend({
        ...
        options: {
            ...
            icon: new L.DivIcon({
                ...
                className: 'leaflet-div-icon leaflet-editing-icon padding-5'
            }),
        ...
        initialize: function (map, options) {
            ...
            this.options.drawError.message = L.drawLocal.draw.handlers.polyline.fourpointonly;
        ...
        _finishShape: function () {
            ...
            // if (this.options.pointOnly && this.options.pointOnly === this._markers.length ) {}
    ...
    L.Draw.Polygon = L.Draw.Polyline.extend({
        ...
        _getTooltipText: function () {
            ...
            } else if (this._markers.length < 4) {
        ...
        _shapeIsValid: function () {
            return this._markers.length >= 4 && this._markers.length <= this.options.maxPoints;
        },
    ...
    L.Edit.SimpleShape = L.Handler.extend({
        options: {
            moveIcon: new L.DivIcon({
                ...
                className: 'leaflet-div-icon leaflet-editing-icon leaflet-edit-move opacity-0'
            }),
            resizeIcon: new L.DivIcon({
                iconSize: new L.Point(20, 20),
                className: 'leaflet-div-icon leaflet-editing-icon leaflet-edit-resize opacity-half'
            }),
    ...
    L.Edit.Rectangle = L.Edit.SimpleShape.extend({
        _createMoveMarker: function () {
            var bounds = this._shape.getBounds(),
                ...
                corners = this._getCorners();
            const moveIcon = this.options.moveIcon
            const x = Math.abs(corners[2].lng - corners[0].lng)
            const y = Math.abs(corners[2].lat - corners[0].lat)
            moveIcon.options.iconSize = new L.Point(x, y)
            this._moveMarker = this._createMarker(center, moveIcon)
        },
